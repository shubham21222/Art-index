...
export default async function handler(req, res) {
  ...
  try {
    ...
    const collection = db.collection("photography_artworks");
    ...
    const formattedArtworks = artworks.map((artwork) => ({
      ...
      image: {
        src: artwork.image?.src || 'https://placehold.co/445x534?text=Photography',
    ...
    console.error("Error fetching photography galleries from MongoDB:", error);
