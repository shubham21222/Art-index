...
export default async function handler(req, res) {
  ...
  try {
    ...
    const db = client.db("new_media_video_db");
    const collection = db.collection("new_media_video");
    ...
    console.error("Error fetching New Media and Video galleries from MongoDB:", error);
