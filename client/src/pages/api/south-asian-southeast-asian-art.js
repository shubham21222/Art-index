...
export default async function handler(req, res) {
  ...
  try {
    ...
    const db = client.db("south_asian_southeast_asian_art_db");
    const collection = db.collection("south_asian_southeast_asian_art");
    ...
    console.error("Error fetching South Asian & Southeast Asian art galleries from MongoDB:", error);
