...
export default async function handler(req, res) {
  ...
  try {
    ...
    const db = client.db("eastern_european_art_db");
    const collection = db.collection("eastern_european_art");
    ...
    console.error("Error fetching Eastern European art galleries from MongoDB:", error);
