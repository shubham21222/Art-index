...
export default async function handler(req, res) {
  ...
  try {
    ...
    const collection = db.collection("emerging_artworks");
    ...
    const formattedArtworks = artworks.map((artwork) => ({
      ...
      image: {
        src: artwork.image?.src || 'https://placehold.co/445x534?text=Emerging+Art',
    ...
    console.error("Error fetching emerging artworks from MongoDB:", error);
