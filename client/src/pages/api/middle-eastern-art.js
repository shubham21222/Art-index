...
export default async function handler(req, res) {
  ...
  try {
    ...
    const db = client.db("middle_eastern_art_db");
    const collection = db.collection("middle_eastern_art");
    ...
    console.error("Error fetching Middle Eastern art galleries from MongoDB:", error);
