      ...
      try {
        const response = await fetch(ARTSY_API_URL, {
          ...
          body: JSON.stringify({
            ...
            variables: {
              id: "ancient-art-artifacts-and-antiquities", // Updated ID for the Ancient Art, Artifacts, and Antiquities category
              category: "GALLERY",
              type: "GALLERY",
            },
          }),
  ...
  return (
    <section className="px-6 py-8">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl">Ancient Art, Artifacts, and Antiquities</h2>
