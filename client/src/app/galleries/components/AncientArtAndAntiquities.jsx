...
const API_URL = "/api/ancient-art-and-antiquities";

export default function AncientArtAndAntiquities() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Error fetching ancient art and antiquities galleries:", error);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="flex flex-col items-center justify-center max-w-[1500px] mx-auto px-6 py-8">
      ...
      <div className="flex flex-col items-center justify-between w-full mb-6">
        <div className="text-center">
          ...
          <p className="text-gray-900 text-lg mt-2">Discover ancient art and antiquities</p>
        </div>
        <Link
          href="#"
