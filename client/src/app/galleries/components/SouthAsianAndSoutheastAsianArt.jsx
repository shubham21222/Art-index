      ...
      try {
        const response = await fetch(ARTSY_API_URL, {
          ...
          body: JSON.stringify({
            ...
            variables: {
              id: "south-asian-and-southeast-asian-art", // Updated ID for the South Asian and Southeast Asian Art category
              category: "GALLERY",
              type: "GALLERY",
            },
          }),
  ...
  return (
    <section className="px-6 py-8">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl">South Asian & Southeast Asian Art</h2>
