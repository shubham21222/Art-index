...
const NEW_MEDIA_AND_VIDEO_QUERY = `
...
export default function NewMediaAndVideo() {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(ARTSY_API_URL, {
          ...
          body: JSON.stringify({
            query: NEW_MEDIA_AND_VIDEO_QUERY,
            variables: {
              id: "new-media-and-video", // ID for the New Media and Video category
              category: "GALLERY",
              type: "GALLERY",
            },
          }),
  ...
  return (
    <section className="px-6 py-8">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl">New Media and Video</h2>
