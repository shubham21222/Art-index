...
const API_URL = "/api/emerging-art";

export default function EmergingArt() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Error fetching emerging artworks:", error);
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="relative h-[500px] w-full perspective-[1200px] overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center">
          {loading ? (
            ...
            <p className="text-gray-500 text-center">No emerging artworks found.</p>
          )}
        </div>
