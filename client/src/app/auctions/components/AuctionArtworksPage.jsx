...
export default function AuctionArtworksPage() {
  ...
  const { loading, error, data } = useQuery(AUCTION_ARTWORKS_QUERY, {
    variables: { slug: "tate-ward-by-collectors-for-collectors-5ac7fd1a-9624-409a-8dc7-86f02bab0893" },
    client,
  });
      ...
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <p className="text-gray-500 text-2xl">
            Starts: {data.sale.formattedStartDateTime}
          </p>
        </div>
        <a href={data.sale.href} className="text-black text-sm font-medium hover:underline">
          View All Lots
        </a>
      </div>
