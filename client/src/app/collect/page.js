  ...
  return (
    ...
    <div className="w-full px-6 py-8">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Collect art and design online</h1>
      ...
      <div className="flex justify-between mt-8 items-center border-b pb-4">
        <div className="flex space-x-4">
          <button className="px-4 py-2 border rounded-md">All Filters</button>
          <button className="px-4 py-2 border rounded-md">Rarity</button>
          <button className="px-4 py-2 border rounded-md">Medium</button>
          <button className="px-4 py-2 border rounded-md">Price Range</button>
        </div>
        <div>
