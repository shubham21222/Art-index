...
export default function BulkUploadModal({ isOpen, onClose, onSuccess }) {
  ...
  const downloadTemplate = () => {
    const templateData = [
      ...
      {
        'Product Title': 'The Scream',
        'Artist': 'Edvard Munch',
        'Price': '18000000',
        'Estimate Price': '16000000-20000000',
        'Starting Bid': '14000000',
        'Reserve Price': '12000000',
        'Type': 'Expressionist Painting',
        'Auction Type': 'TIMED',
        'SKU': 'ART004',
        'Lot Number': 'LOT#4',
        'Internal ID': 'AUCTION_004',
        'Description': 'Expressionist masterpiece depicting existential angst and human emotion',
        'Details': 'Tempera on cardboard, 91 x 73.5 cm, 1893',
        'Medium': 'Tempera on Cardboard',
        'Dimensions': '91" x 73.5" cm',
        'Stock': '1',
        'Image URL': 'https://example.com/scream.jpg',
        'Sort By Price': 'High Price'
      },
      {
        'Product Title': 'Water Lilies Series',
        'Artist': 'Claude Monet',
        'Price': '8500000',
        'Estimate Price': '7500000-9500000',
        'Starting Bid': '6000000',
        'Reserve Price': '5500000',
        'Type': 'Impressionist Painting',
        'Auction Type': 'TIMED',
        'SKU': 'ART005',
        'Lot Number': 'LOT#5',
        'Internal ID': 'AUCTION_005',
        'Description': 'Beautiful impressionist painting from Monet\'s famous water lilies series',
        'Details': 'Oil on canvas, 200 x 200 cm, 1919',
        'Medium': 'Oil on Canvas',
        'Dimensions': '200" x 200" cm',
        'Stock': '1',
        'Image URL': 'https://example.com/water-lilies.jpg',
        'Sort By Price': 'High Price'
      },
      {
        'Product Title': 'The Birth of Venus',
        'Artist': 'Sandro Botticelli',
        'Price': '25000000',
        'Estimate Price': '22000000-28000000',
        'Starting Bid': '20000000',
        'Reserve Price': '18000000',
        'Type': 'Renaissance Painting',
        'Auction Type': 'TIMED',
        'SKU': 'ART006',
        'Lot Number': 'LOT#6',
        'Internal ID': 'AUCTION_006',
        'Description': 'Renaissance masterpiece depicting the birth of Venus from sea foam',
        'Details': 'Tempera on canvas, 172.5 x 278.5 cm, 1485',
        'Medium': 'Tempera on Canvas',
        'Dimensions': '172.5" x 278.5" cm',
        'Stock': '1',
        'Image URL': 'https://example.com/birth-venus.jpg',
        'Sort By Price': 'High Price'
      },
      {
        'Product Title': 'Guernica',
        'Artist': 'Pablo Picasso',
        'Price': '35000000',
        'Estimate Price': '30000000-40000000',
        'Starting Bid': '25000000',
        'Reserve Price': '22000000',
        'Type': 'Cubist Painting',
        'Auction Type': 'TIMED',
        'SKU': 'ART007',
        'Lot Number': 'LOT#7',
        'Internal ID': 'AUCTION_007',
        'Description': 'Powerful anti-war painting depicting the horrors of the Spanish Civil War',
        'Details': 'Oil on canvas, 349.3 x 776.6 cm, 1937',
        'Medium': 'Oil on Canvas',
        'Dimensions': '349.3" x 776.6" cm',
        'Stock': '1',
        'Image URL': 'https://example.com/guernica.jpg',
        'Sort By Price': 'High Price'
      },
      {
        'Product Title': 'The Night Watch',
        'Artist': 'Rembrandt van Rijn',
        'Price': '28000000',
        'Estimate Price': '25000000-31000000',
        'Starting Bid': '22000000',
        'Reserve Price': '20000000',
        'Type': 'Dutch Golden Age',
        'Auction Type': 'TIMED',
        'SKU': 'ART008',
        'Lot Number': 'LOT#8',
        'Internal ID': 'AUCTION_008',
        'Description': 'Famous group portrait of a militia company, showcasing Rembrandt\'s mastery of light and shadow',
        'Details': 'Oil on canvas, 363 x 437 cm, 1642',
        'Medium': 'Oil on Canvas',
        'Dimensions': '363" x 437" cm',
        'Stock': '1',
        'Image URL': 'https://example.com/night-watch.jpg',
        'Sort By Price': 'High Price'
      },
      {
        ...
        'Artist': 'Grant Wood',
        'Price': '12000000',
        'Estimate Price': '10000000-14000000',
        'Starting Bid': '8000000',
        'Reserve Price': '7000000',
        'Type': 'Regionalist Painting',
        'Auction Type': 'TIMED',
        'SKU': 'ART009',
        'Lot Number': 'LOT#9',
        'Internal ID': 'AUCTION_009',
        'Description': 'Iconic American painting depicting a farmer and his daughter in front of their house',
        'Details': 'Oil on beaverboard, 78 x 65.3 cm, 1930',
        'Medium': 'Oil on Beaverboard',
        'Dimensions': '78" x 65.3" cm',
        'Stock': '1',
        'Image URL': 'https://example.com/american-gothic.jpg',
        'Sort By Price': 'High Price'
      },
      {
        'Product Title': 'The Kiss',
        'Artist': 'Gustav Klimt',
        'Price': '15000000',
        'Estimate Price': '13000000-17000000',
        'Starting Bid': '11000000',
        'Reserve Price': '10000000',
        'Type': 'Art Nouveau',
        'Auction Type': 'TIMED',
        'SKU': 'ART010',
        'Lot Number': 'LOT#10',
        'Internal ID': 'AUCTION_010',
        'Description': 'Beautiful Art Nouveau painting depicting a couple in a passionate embrace',
        'Details': 'Oil and gold leaf on canvas, 180 x 180 cm, 1908',
        'Medium': 'Oil and Gold Leaf on Canvas',
        'Dimensions': '180" x 180" cm',
        'Stock': '1',
        'Image URL': 'https://example.com/kiss.jpg',
        'Sort By Price': 'High Price'
      }
    ];
    ...
    // Generate Excel file
    XLSX.writeFile(wb, 'auction_template_10_items.xlsx');
  };
