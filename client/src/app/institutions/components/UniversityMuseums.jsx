...
const UNIVERSITY_MUSEUMS_QUERY = `
        ...
        const fetchData = async () => {
            try {
                const response = await fetch(ARTSY_API_URL, {
                    ...
                    body: JSON.stringify({
                        query: UNIVERSITY_MUSEUMS_QUERY,
                        variables: {
                            id: "university-museums-slash-educational-institutions",
    ...
    return (
        <section className="px-6 py-8">
            ...
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl">University Museums & Educational Institutions</h2>
