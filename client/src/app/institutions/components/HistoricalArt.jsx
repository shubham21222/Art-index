...
const API_URL = "/api/historical-art";

export default function HistoricalArt() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Error fetching historical art institutions:", error);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="flex flex-col items-center justify-center max-w-[1500px] mx-auto px-6 py-8">
      ...
      <div className="flex flex-col items-center justify-between w-full mb-6">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900">Historical Art</h2>
          <p className="text-gray-900 text-lg mt-2">Discover leading historical art institutions</p>
        </div>
        <Link
          href="/institutions/historical-art"
