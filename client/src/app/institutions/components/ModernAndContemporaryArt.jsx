...
const MODERN_AND_CONTEMPORARY_ART_QUERY = `
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(ARTSY_API_URL, {
          ...
          body: JSON.stringify({
            query: MODERN_AND_CONTEMPORARY_ART_QUERY,
            variables: {
              id: "modern-and-contemporary-art",
  ...
  return (
    <section className="px-6 py-8">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl">Modern & Contemporary Art</h2>
